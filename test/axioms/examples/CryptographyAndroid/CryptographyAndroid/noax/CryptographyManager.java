...
public final class CryptographyManager {
    ...
    private final String PREF_PUBLIC_KEY = "prefrencePublicKey";
    public final String ENCODE_FORMAT = "UTF-8";
	...
	String suffix = "INTEGRITY_SUFFIX";
        KeyStore.Entry integrityKey = keyStore.getEntry(suffix.concat(keyStoreAlias), null);

	if (entry instanceof KeyStore.SecretKeyEntry) assert false;
	...
	hMac.init(integrityKey);
        ...
        if (Utils.constantTimeEq(computedMac, cipherTextContainer.getMac())) {
            ...
            aesCipherForDecryption.init(2, decryptionKey, new IvParameterSpec(cipherTextContainer.getIv()));
            // return new String(aesCipherForDecryption.doFinal(cipherTextContainer.getCipherText()), ENCODE_FORMAT);
            return new String(aesCipherForDecryption.doFinal(cipherTextContainer.getCipherText()));
        }
	// else
    ...
    private String decryptCipherText(String cipherText, Key privateKey) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException, UnsupportedEncodingException, BadPaddingException, IllegalBlockSizeException {
        ...
        byte[] plainText = Utils.decodeWithBuffer(cipherDecrypt, cipherText.getBytes(), 128 / 8);
    ...
    public static final class AES {
        ...
        public final String CIPHER_TRANSFORMATION = "AES/CBC/PKCS7Padding";
        public final String CIPHER = "AES";
        public final int KEY_LENGTH_BITS = 128;
    }
    ...
    public static final class RSA {
        ...
        public final String CIPHER_TRANSFORMATION = "RSA/ECB/PKCS1Padding";
        public final String CIPHER = "RSA";
        public final int KEY_LENGTH_BITS = 1024;
    }

    public static final class HMAC {
        // public static final String INTEGRITY_SUFFIX = BuildConfig.APPLICATION_ID + "INTEGRITY_SUFFIX";
        // public static final String INTEGRITY_SUFFIX = "INTEGRITY_SUFFIX";
        // public static final String CIPHER = "HmacSHA256";
        public final String INTEGRITY_SUFFIX = "INTEGRITY_SUFFIX";
        public final String CIPHER = "HmacSHA256";
    }


    public static final class KeyStoreConstants {
        // public static final String PROVIDER = "AndroidKeyStore";
        public final String PROVIDER = "AndroidKeyStore";
