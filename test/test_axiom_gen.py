...
tests = os.path.join(pwd, "axioms/axiom_gen/")
...
#################################################################
    ...
    #     files = ["SuffixArray_noholes.java", "SuffixArrayTest.java", "rewrite/"]        
    #     files = map(lambda s: "SuffixArray/" + s, files)
    #     inline = 3
    #     unroll = 8
    #     self.__test(files, inline, unroll)        
    ...
    #     files = ["HashTable_noholes.java", "HashTableNode.java", "HashTableTest.java", "rewrite/", "shared/"]
    #     files = map(lambda s: "HashMap1/" + s, files)
    #     inline = 3
    #     unroll = 13
    #     self.__test(files, inline, unroll)
