...
import com.github.javaparser.ast.stmt.AssumeStmt;
...
import com.github.javaparser.ast.stmt.MinrepeatStmt;
...
public class DumpVisitor implements VoidVisitor<Object> {
    ...
    @Override public void visit(final GeneratorExpr n, final Object arg) {
	printJavaComment(n.getComment(), arg);
	if (n.getIsHole()) {
	    printer.print("??");
	}
	    ...
	    printer.print("{| ");
	    if (!isNullOrEmpty(n.getExprs())) {
	    for (final Iterator<Expression> i = n.getExprs().iterator(); i.hasNext();) {
		final Expression e = i.next();
		e.accept(this, arg);
		if (i.hasNext()) {
		    printer.print(", ");
    ...
    @Override public void visit(final AssumeStmt n, final Object arg) {
	printJavaComment(n.getComment(), arg);
    ...
    @Override public void visit(final MinrepeatStmt n, final Object arg) {
	printJavaComment(n.getComment(), arg);
	printer.print("minrepeat ");
	n.getBody().accept(this, arg);
    }
