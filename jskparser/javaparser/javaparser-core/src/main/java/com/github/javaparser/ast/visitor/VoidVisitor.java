...
public interface VoidVisitor<A> {
	...
	void visit(AxiomDeclaration n, A arg);

	void visit(AxiomParameter n, A arg);
	...
	void visit(GeneratorExpr n, A arg);
	...
	void visit(MinrepeatStmt n, A arg);
