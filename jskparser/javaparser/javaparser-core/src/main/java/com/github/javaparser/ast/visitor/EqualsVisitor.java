...
public class EqualsVisitor implements GenericVisitor<Boolean, Node> {
	...
	@Override public Boolean visit(final GeneratorExpr n1, final Node arg) {
		return Boolean.TRUE;
	}
	...
	@Override public Boolean visit(final AssumeStmt n1, final Node arg) {
	    final AssumeStmt n2 = (AssumeStmt) arg;
	...
	@Override public Boolean visit(final MinrepeatStmt n1, final Node arg) {
		final MinrepeatStmt n2 = (MinrepeatStmt) arg;
