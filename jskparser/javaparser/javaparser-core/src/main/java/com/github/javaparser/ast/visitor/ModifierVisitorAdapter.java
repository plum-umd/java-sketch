...
import com.github.javaparser.ast.expr.GeneratorExpr;
...
public abstract class ModifierVisitorAdapter<A> implements GenericVisitor<Node, A> {
	...
	@Override public Node visit(final AssumeStmt n, final A arg) {
	...
	@Override public Node visit(final GeneratorExpr n, final A arg) {
		return n;
	}
	...
	@Override public Node visit(final MinrepeatStmt n, final A arg) {
		n.setBody((Statement) n.getBody().accept(this, arg));
		return n;
	}
