...
public class CloneVisitor implements GenericVisitor<Node, Object> {
	...
	@Override
	public Node visit(GeneratorExpr _n, Object _arg) {
		Comment comment = cloneNodes(_n.getComment(), _arg);
	...
	@Override
	public Node visit(AssumeStmt _n, Object _arg) {
		Expression expr = cloneNodes(_n.getExpr(), _arg);
		Comment comment = cloneNodes(_n.getComment(), _arg);

		AssumeStmt r = new AssumeStmt(
				_n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(),
				expr
		);
		r.setComment(comment);
	...
	@Override
	public Node visit(MinrepeatStmt _n, Object _arg) {
		Statement body = cloneNodes(_n.getBody(), _arg);
		Comment comment = cloneNodes(_n.getComment(), _arg);

		MinrepeatStmt r = new MinrepeatStmt(
				_n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(),
				body
		);
		r.setComment(comment);
