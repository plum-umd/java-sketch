...
public abstract class VoidVisitorAdapter<A> implements VoidVisitor<A> {
	...
	@Override public void visit(final AssumeStmt n, final A arg) {
		visitComment(n.getComment(), arg);
	}
	...
	@Override public void visit(final GeneratorExpr n, final A arg) {
		visitComment(n.getComment(), arg);
	}
	...
	@Override public void visit(final MinrepeatStmt n, final A arg) {
		visitComment(n.getComment(), arg);
		n.getBody().accept(this, arg);
	}
